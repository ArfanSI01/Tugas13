...
badak = Badak("Badak", "Rumput", "Daratan", "Melahirkan", "50 Tahun", "Jantan")
ikan = Ikan("Ikan", "Makanan Ikan", "Air", "Bertelur", "50 Ekor", "Koi")
ular = Ular("Ular", "Ayam", "Alam Bebas", "Bertelur", "5 Meter", "Iya")
